In this exercise we are going to create double variables, assign them values, and then learn how to divide them and store the result in another double variable.
